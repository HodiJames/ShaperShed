          ...
          <div className="ld-meta">
            ...
            {(listing.website || listing.instagram) && (
              <div className="ld-mi">
                ...
                <div className="ld-cats">
                  {listing.website && (
                    <a className="ld-cat" href={listing.website} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()}>Website ↗</a>
                  )}
                  {listing.instagram && (
                    <a className="ld-cat" href={`https://instagram.com/${listing.instagram}`} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()}>Instagram ↗</a>
                  )}
                </div>
              </div>
            )}
