        ...
        <div className="ld-hcard">
          ...
          <div className="ld-meta">
            ...
            {(listing.website || listing.instagram) && (
              <div className="ld-mi ld-mi-links">
                <span className="ld-mil">Links</span>
                <div className="ld-link-pills">
                  {listing.website && (
                    <a className="ld-pill" href={listing.website} target="_blank" rel="noopener noreferrer">Website ↗</a>
                  )}
                  {listing.instagram && (
                    <a className="ld-pill" href={`https://instagram.com/${listing.instagram}`} target="_blank" rel="noopener noreferrer">Instagram ↗</a>
                  )}
                </div>
              </div>
            )}
